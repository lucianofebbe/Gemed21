    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<AuthenticationResponse> AuthenticationAsync()
        {
            try
            {
                ...
                var repoRequests = iRepositoryFactory.CreateRequests(new Context(request.ConnectionString, request.ProviderName), cancellationToken);
                var repoCommands = iRepositoryFactory.CreateCommands(new Context(request.ConnectionString, request.ProviderName), cancellationToken);
